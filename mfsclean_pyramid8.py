...
for n in range(sbstart, sbend):
	...
	clean(vis, spw=spwr, field='0', mode='mfs', gridmode='widefield', wprojplanes=wp, facets=fac, imagename=name, niter=its, interactive=False, imsize=[npix, npix], cell=ceil(synthbeamasec[n+7]))
