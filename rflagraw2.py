...
# This script (rflagraw2.py) uses ntime=scan
...
for x in range(0,120):
	...
	flagdata(vis, mode='rflag', spw=str(x), timedevscale=10, action='apply', display='', flagbackup=True, savepars=True, extendflags=True)
...
# Save results:
fl = open('flaggingAug82014_2a.txt', 'w')
